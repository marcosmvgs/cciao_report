...
indisp_dataframe = indisp_raw_dataframe[(indisp_raw_dataframe['Tripulante'].str.contains('QO') == True) & (indisp_raw_dataframe['Data'].dt.year == 2023)]
